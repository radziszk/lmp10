...
bool done = 0,done1=0,done2=0,done3=0;
...
fi(double a, double b, int n, int i, double x)
{
	...
	for(i=0;i<100;i++)
	{
		suma=suma+(pow(x,i) * wielomian[stopien][i]); 	
	}
	/////// dodac wypisywanie wielomianow
	return suma;	
}
...
dfi(double a, double b, int n, int i, double x)
{
	...
	for(i=0;i<100;i++)
	{
		suma+= pow(x,i) * pochodna[stopien][i]; 
	}
...
d2fi(double a, double b, int n, int i, double x)
{
	...
	for(i=0;i<100;i++)
	{
		suma+= pow(x,i) * druga_pochodna[stopien][i];
	}
...
d3fi(double a, double b, int n, int i, double x)
{
	int stopien=n;
        ...
        for(i=0;i<100;i++)
        {
                suma+= pow(x,i) * trzecia_pochodna[stopien][i];
        }
